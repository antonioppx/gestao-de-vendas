...
import { getVendasSemana, Venda } from '../services/api';

const VendasSemana: React.FC = () => {
  ...
  useEffect(() => {
    const carregarVendas = async () => {
      try {
        setLoading(true);
        const data = await getVendasSemana();
    ...
    return (
      <div className="card">
        <div className="text-center">
          <p>Carregando vendas da semana...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="card">
        <div className="card-header">
          <div className="flex items-center gap-4">
            ...
            <h1 className="card-title">Vendas da Semana</h1>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        {vendas.length === 0 ? (
          <div className="text-center p-8">
            ...
            <h3 className="text-lg font-semibold mb-2">Nenhuma venda registrada esta semana</h3>
            <p className="text-gray">
              Não há vendas registradas para o período de {periodo.inicio} a {periodo.fim}.
            </p>
          </div>
        ) : (
